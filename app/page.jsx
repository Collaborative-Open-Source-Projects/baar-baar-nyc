        ...
        <main className='min-h-screen'>
            ...
            <section className='bg-accent h-full flex flex-col md:flex-row md:justify-center items-center px-5 py-7 gap-4'>
                <div className='text-white text-sm flex flex-col gap-4 w-3/4'>
                    <h1 className='text-xl font-semibold text-center md:text-left'>Baar Baar Delivery and Pick Up</h1>
                    <p className='text-center md:text-left'>
                        Baar Baar's Take Out menu is now available for delivery
                        through ChowNow and other Delivery platforms.
                    </p>
                    <p className='text-center md:text-left'>Tuesday to Sunday - Dinner: 4:30pm to 10pm.</p>
                    <p className='text-center md:text-left'>For Pick up: email: delivery@baarbaarnyc.com or call 212.228.1200</p>
                </div>
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 items-center justify-center w-full md:min-h-[80vh] bg-[url("/images/pages/homepage/baarBg.jpg")] bg-cover bg-center'>
                <div className="px-5 py-7 flex flex-col gap-5 justify-center items-center md:w-2/3 mx-auto text-center">
                    <h1 className="text-2xl font-semibold text-teal-500">OUR CUISINE</h1>
                    <p>
                ...
                <div className="h-full w-full min-h-[80vh] flex">
                    <Image src={baarImg} alt="Cuisine Img" className="h-full w-full object-cover" />
                </div>
            </section>

            <section className='grid grid-cols-1 md:grid-cols-2 items-center justify-center w-full md:min-h-[80vh] bg-[url("/images/pages/homepage/baarBg.jpg")] bg-cover bg-center'>
                <div className="px-5 py-7 flex flex-col gap-5 justify-center items-center md:w-2/3 mx-auto text-center md:order-2">
                    <h1 className="text-2xl font-semibold text-teal-500">OUR COCKTAILS</h1>
                    <p>
                ...
                <div className="h-full w-full min-h-[80vh] flex">
                    <Image src={baarDrinksImg} alt="Cocktails Img" className="h-full w-full object-cover" />
                </div>
            </section>

            <section className='grid grid-cols-1 md:grid-cols-2 items-center justify-center w-full md:min-h-[80vh] bg-[url("/images/pages/homepage/baarBg.jpg")] bg-cover bg-center'>
                <div className="px-5 py-7 flex flex-col gap-5 justify-center items-center md:w-2/3 mx-auto text-center">
                    <h1 className="text-2xl font-semibold text-teal-500">ABOUT BAAR BAAR</h1>
                    <p>
                ...
                <div className="h-full w-full min-h-[80vh] flex">
                    <Image src={baarChefImg} alt="Chef Img" className="h-full w-full object-cover" />
                </div>
            </section>
        </main>
    );
