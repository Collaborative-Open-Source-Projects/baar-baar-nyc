        ...
        >
            <div className='w-36'>
                <Image
                    ...
                    height={144}
                />
                <p className='text-sm text-[#DDDDDD] mt-2'>
                    &copy; 2025 Baar Baar Site by PSD
                </p>
            </div>
            ...
            <div>
                ...
                <p className='text-sm text-[#DDDDDD]'>
                    Tuesday to Thursday: 5:00pm to 11:00pm
                </p>
                <p className='text-sm text-[#DDDDDD]'>
                    Friday: 5:00pm to 12:00am
                </p>
                <p className='text-sm text-[#DDDDDD]'>
                    Saturday: 5:30pm to 12:00am
                </p>
                <p className='text-sm text-[#DDDDDD]'>
                ...
                <div className='mt-4'>
                    ...
                    <h1 className='text-base text-[#DDDDDD]'>Dinner</h1>
                    <p className='text-sm text-[#DDDDDD]'>
                        Tuesday to Sunday: 5:00pm - 9:30pm
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='flex flex-col gap-4 mt-2'>
                    <a
                        href='#'
                        className='flex items-center gap-4 hover:underline hover:text-white'
                    >
                        <FontAwesomeIcon
                            icon={faFacebookF}
